...
export const domainInput: IFormItemConfig      = {type: 'value', name: 'domain', title: 'Project Domain', calc: () => getDomain()};
export const descriptionInput: IFormItemConfig = {type: 'text', name: 'description', title: 'Project Description'};
export const projectInput: IFormItemConfig = {name: 'project', title: 'Project', type: 'project'};