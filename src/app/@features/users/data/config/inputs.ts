...
export const nameInput: IFormItemConfig              = {type: 'text', name: 'name', title: 'Name'};
export const usernameInput: IFormItemConfig          = {type: 'text', name: 'username', title: 'Username'};
export const passwordConfirmInput: IFormItemConfig   = {type: 'password', name: 'passwordConfirm', title: 'Confirm Password'};