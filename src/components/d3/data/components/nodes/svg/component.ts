...
import {svg_selectCircles, svg_selectNodes} from './selectors';
import {node_selectRadius, node_selectX, node_selectY} from '../datum/selectors';
...
export const nodeComponent: SimulationElement =
                 ({
                     name: COMPONENT_NAME,
                     update(svg: SvgSelection, data: SimulationData) {
                         ...
                         const circles = wrapperData.enter().selectAll('circle') as NodeDatumSelection;
