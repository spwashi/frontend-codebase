...
import {svg_selectCircles, svg_selectClusters} from './selectors';
import {cluster_selectRadius, cluster_selectX, cluster_selectY} from '../datum/selectors';
import {addDragBehavior} from '../behaviors/drag';
import {addZoomBehavior} from '../behaviors/zoom';
import styleClusters from './style';


export const clusterComponent: SimulationElement =
                 ({
                     name: COMPONENT_NAME,
